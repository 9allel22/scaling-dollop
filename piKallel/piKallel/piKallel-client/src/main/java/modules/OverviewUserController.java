...
List<Event>	event =  eventManagementRemote.findEventByMultiChoices(comboReg1.getSelectionModel().getSelectedItem().toString(), comboStation1.getSelectionModel().getSelectedItem().toString());
